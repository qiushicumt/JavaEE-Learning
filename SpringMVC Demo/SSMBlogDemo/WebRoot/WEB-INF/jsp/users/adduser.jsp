	...
	<div class="wrappage">
	    ...
	    <div class="container content-container">
	    	<div class="jumbotron jumbotron-padding">
	    		<h2>新增用户</h2>
	    		<hr>
	    		<form class="form-horizontal" action="${pageContext.request.contextPath }/ssm/users/insertNewUser" method="POST">
	    			<div class="form-group">
	    				<label class="control-label col-xs-1" for="user-name">UserName:</label>
	    				<div class="col-xs-5">
	    					<input type="text" name="userCustom.userName" id="user-name" class="form-control" placeholder="请输入 username" >
	    				</div>
	    			</div>
	    			<div class="form-group">
	    				<label class="control-label col-xs-1" for="user-password">Password:</label>
	    				<div class="col-xs-5">
	    					<input type="password" name="userCustom.userPassword" id="user-password" class="form-control" placeholder="请输入 password">
	    				</div>
	    			</div>
	    			<div class="form-group">
	    				<label class="control-label col-xs-1" for="first-name">FirstName:</label>
	    				<div class="col-xs-5" >
	    					<input type="text" name="userCustom.firstName" id="first-name" class="form-control" placeholder="请输入 firstname">
	    				</div>
	    			</div>
	    			<div class="form-group">
	    				<label class="control-label col-xs-1" for="last-name">LastName:</label>
	    				<div class="col-xs-5" >
	    					<input type="text" name="userCustom.lastName" id="last-name" class="form-control" placeholder="请输入 lastname">
	    				</div>
	    			</div>
	    			<div class="form-group">
	    				<div class="col-xs-4">
